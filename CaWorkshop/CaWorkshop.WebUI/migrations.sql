...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210812004420_Todos')
BEGIN
    CREATE TABLE [TodoLists] (
        [Id] int NOT NULL IDENTITY,
        [Title] nvarchar(280) NOT NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20210812004420_Todos', N'5.0.9');
END;
GO
